...
public class TouchImageView extends ImageView {
    ...
    private static final float CURRENCY = 0.1f;
    ...
    public void setPager(CustomPager pager) {
        this.pager = pager;
    }
    ...
    public boolean dispatchTouchEvent(MotionEvent event) {
        ...
        //return super.dispatchTouchEvent(event);    //To change body of overridden methods use File | Settings | File Templates.
    }
